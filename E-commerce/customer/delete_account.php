...
if(isset($_POST['submit'])){
	...
	echo "<script>alert('You are about to delete your account!!');</script>";
		 
	$name = $_SESSION['sess_user'];
	$tbl = "Cart-".$name;
		$sql = "drop table `{$tbl}`";
		$sql1 = 'delete from customer where username = "'.$name.'"';
			mysql_query($sql);
			mysql_query($sql1);
	...
	<div class="main_wrapper">
		...
		<div class="content">
			...
			<div id="right_content">
				...
				<br>
				<form method="POST">
					<table style="margin-left:320px;border:1px solid black">
						<tr>
						<td><input type="submit" name="submit" value="Delete account"><td>
						<td><input type="button" value="Go Back" onclick="window.open('manage_account.php','_self');"></td>
						</tr>
					</table>
				</form>
			</div>
